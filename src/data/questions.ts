...
export const questions: Question[] = [
    {
        ...
        explanation:
            "Performance requirements significantly influence the choice between native and other development approaches. Native development provides the best performance but comes with higher development costs.",
        options: [
            {
    ...
    },
    {
        ...
        explanation:
            "The target platforms affect development costs and maintenance overhead. Cross-platform solutions can reduce development time for multi-platform apps.",
        options: [
            {
                text: "iOS only",
